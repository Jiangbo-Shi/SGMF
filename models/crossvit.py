...
class MultiScaleTransformerEncoder(nn.Module):
    ...
    def __init__(self, small_dim=512, small_depth=4, small_heads=4, small_dim_head=128, small_mlp_dim=512,
                 large_dim=512, large_depth=1, large_heads=4, large_dim_head=128, large_mlp_dim=512,
...
class CrossViT(nn.Module):
    def __init__(self, num_classes, small_dim=512,
                 large_dim=512, small_depth=1, large_depth=4, cross_attn_depth=1, multi_scale_enc_depth=1,
    ...
    def forward(self, xs, xl):
        ...
        # generate feature: mean_pooling; cls token
